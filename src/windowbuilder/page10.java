...
public class page10 {
	...
	private void initialize() {
		...
		txtpnroughnessbreathiness1.setText("你會聽到一個音檔，請你以100mm長視覺類比量表評估音檔的粗糙聲程度；最左邊代表正常, 最右邊代表嚴重粗糙，請拉動標示至適當位置，你可以按圖示重覆聆聽聽覺錨，每個最多五次。完成後請按確定答案按鈕。");
		...
		txtpnroughnessbreathiness5.setText("你會聽到一個音檔，請你以100mm長視覺類比量表評估音檔的氣息聲程度；最左邊代表正常, 最右邊代表嚴重粗糙，請拉動標示至適當位置，你可以按圖示重覆聆聽聽覺錨，每個最多五次。完成後請按確定答案按鈕。");
		...
		txtpnroughnessbreathiness7.setText("與專家評分相差8mm以內為正確，完成12題後會告訴你準確率。");
		...
		txtpnroughnessbreathiness8.setText("一共有3組訓練；1組12題；第3組訓練不會提供建議答案。");
		...
		btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				File fileout = new File(System.getProperty("user.dir") + "/(F組)訓練_" + page1.str + "_" + page1.strN + ".csv");
				try {

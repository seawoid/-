...
public class page20 {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("測試方法－追蹤");
		...
		lblNewLabel_3.setBounds((frame.getWidth()/100)*6, (frame.getHeight()/20)*6+74, 25, 47);
		...
		JButton btn = new JButton("前往練習題",icon);

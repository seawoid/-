...
public class page9_3 {
	...
	private void initialize() {
		...
		JLabel lblNewLabel = new JLabel("<html> 第三組結束；休息１分鐘 </html>");
		...
		JButton btn = new JButton("或直接繼續訓練",icon);
		...
		btn.setBounds( (frame.getWidth()/100)*43, (frame.getHeight()/20)*15, 450,84);
		btn.setBorderPainted(false);
